...
func (c *Creator) getCreateDpcShareParam() (*client.CreateDpcShareParam, error) {
	...
	if len(dtShareParam.DpcAuth) == 0 {
		return nil, errors.New("create filesystem failed: DpcAuth is empty")
	}
...
func (c *Creator) getCreateFilesystemParams() (*client.CreateFilesystemParams, error) {
	...
	default:
		return nil, fmt.Errorf("protocol(%s) invalid", c.params.Protocol)
	}
	return param, nil
}
